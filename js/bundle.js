...
function cards() {
    ...
    (0,_services_serveces__WEBPACK_IMPORTED_MODULE_0__.getResourse)('http://localhost:3000/menu',)
        .then(data => {
...
/* harmony import */ var _services_serveces__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/serveces */ "./js/services/serveces.js");
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            (0,_services_serveces__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)
                .then(data => {
                    //console.log(data);
...
function slider() {
    ...
    const opacityChoice = (dots, index) => {
        dots.forEach(dot => dot.style.opacity = '.5');
        dots[index].style.opacity = 1;
    }

    const slideIndexChoice = (slides) => {
        if (slides.length < 10) {
            current.textContent = `0${slideIndex}`;
        } else {
            current.textContent = slideIndex;
    ...
    next.addEventListener('click', () => {
        ...
        slideIndexChoice(slides);
        opacityChoice(dots, slideIndex - 1);
    });
...
const postData = async (url, data) => {
    const res = await undefined.fetch(url, {
        method: 'POST',
        headers: {
